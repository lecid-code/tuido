...
class ArgumentParser:
    ...
    def __init__(self, prog_name: Optional[str] = None, description: Optional[str] = None):
        """
        ...
        self.parser = argparse.ArgumentParser(
            prog=prog_name,
            description=description or f"{prog_name} - A terminal-based todo list manager"
        )
    ...
    def _add_global_arguments(self) -> None:
        ...
        self.parser.add_argument(
            ...
            help='Path to the task file (default: ~/.tasks.json or value of TODO_FILE environment variable)'
        )
    ...
    def _add_undo_command(self, subparsers) -> None:
        ...
        undo_parser = subparsers.add_parser("undo", help="Mark a previously completed task as active")
        undo_parser.add_argument(
            "task_id", 
            help="ID of the task to revert", 
            type=int
        )
